...
public class XmlFileParsingTest extends AbstractInfinispanTest {
   ...
   private void assertNamedCacheFile(ConfigurationBuilderHolder holder, boolean deprecated) {
      ...
      assertEquals(1, asyncThreadPool.coreThreads());
      assertEquals(2, asyncThreadPool.maxThreads());
      assertEquals(4, asyncThreadPool.queueLength());
      assertEquals(8, asyncThreadPool.keepAlive());
